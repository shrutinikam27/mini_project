...
export const units = pgTable("units", {
    ...
    description: text("description").notNull(), //learn the basics from spanish
...
export const challenges = pgTable("challenges", {
    ...
    question: text("question").notNull(), // "What is the capital of Spain?"
    order: integer("order").notNull(),
});
...
export const challengeOptions = pgTable("challenge_Options", {
    ...
    correct: boolean("correct").notNull(), // true or false
